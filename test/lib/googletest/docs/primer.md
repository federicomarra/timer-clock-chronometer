...
discouraged by the Google [C++ Style Guide](https://google.github.io/styleguide/cppguide.html#Operator_Overloading),
...
| `ASSERT_STRCASENE(str1, str2);`  | `EXPECT_STRCASENE(str1, str2);` | the two C strings have the different content, ignoring case |
